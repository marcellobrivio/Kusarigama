...
<?php if ( !dynamic_sidebar('Footer') ) : ?>
 ...
 <?php endif; ?>
			...
			<div id="feedLinks">
				<p class="rss"><a href="<?php bloginfo('rss2_url'); ?>" onclick="window.open(this.href); return false;" onkeypress="window.open(this.href); return false;">RSS Feed</a></p>
			...
			<p class="credits">&copy; <?php bloginfo('name'); ?> <?php echo date('Y'); ?> | Powered by <a href="http://www.wordpress.org/" title="WordPress, the best platform for bloging &amp; more">WordPress</a> and <a href="http://www.marcellobrivio.com/wordpress/kusarigama/" title="Kusarigama Theme for WordPress">Kusarigama</a>, a theme by Marcello Brivio | This page has been tested in all major browsers.</p>
